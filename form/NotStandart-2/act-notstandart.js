...
// скрипт для табов и выбора времени
 // Логика переключения табов смен
...
tabs.forEach(tab => {
    tab.addEventListener('click', () => {
        ...
        // Исправленная строка (убрана лишняя скобка в конце):
        const targetContent = document.querySelector(`[data-tab-content="${tab.dataset.tab}"]`);
        targetContent.classList.add('active');
    });
});

// Логика выбора времени (клик на плашку окрашивает её в зеленый)
